...
export const metadata: Metadata = {
  title: "צור קשר",
  description: "צרו קשר עם צוות פולימרקט ישראל - נשמח לענות על שאלות ולקבל משוב. זמן תגובה 24-48 שעות.",
  alternates: {
    canonical: "/contact",
  },
  openGraph: {
          ...
          <div className="bg-[var(--background)] rounded-2xl p-8 space-y-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-[var(--primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-[var(--accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
